...
def button(x, y, text):
    sc.blit(font(18, text, (0, 175, 0) if difficult == text else white), [x, y])
...
def change_difficult(dif):
    ...
    for i in range(num_x):
        for j in range(num_y):
            ...
            pygame.draw.rect(sc, gray, [i*c_size, j*c_size + bd_h, *[c_size - 1] * 2])
...
class Bomb:
    ...
    def draw(self):
        ...
        pygame.draw.circle(sc, (175, 0, 0), [self.x*c_size+c_size//2, self.y*c_size+c_size//2+bd_h], rad)
